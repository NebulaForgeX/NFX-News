/**
 * Source 模块配置类
 * 类似 Sjgz-Backend 的 internal/source/config/config.go
 * 包含配置类和验证逻辑
 */
...
import type { SourceConfigType, ServerConfig, FeatureFlags, ProductHuntConfig } from './types'
 ...
 * 所有字段都是必需的，不允许有默认值
 */
export class SourceConfig implements SourceConfigType {
