...
export const LOGO_LIGHT = publicUrl("logo.png");
export const LOGO_DARK = publicUrl("logo.png");
export const LOGO_LIGHT_ICO = publicUrl("logo.ico");
export const LOGO_DARK_ICO = publicUrl("logo.ico");
