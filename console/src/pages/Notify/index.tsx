import { FilledBellIcon, RouterIcon, MailFilledIcon } from "nfx-ui/icons";
  ...
  return (
    <PageFrame>
      ...
      <Flex direction="column" gap="4">
        <Card>
          <CardHeader icon={<RouterIcon size={18} />} title={t("system")} />
        ...
        <Card>
          <CardHeader icon={<FilledBellIcon size={18} />} title={t("channels")} />
          ...
          {(channels ?? []).length === 0 ? (
            <EmptyState icon={FilledBellIcon} title={t("emptyChannels")} />
          ) : (
        ...
        <Card>
          <CardHeader icon={<MailFilledIcon size={18} />} title={t("deliveries")} />
          {(deliveries ?? []).length === 0 ? (
            <EmptyState icon={MailFilledIcon} title={t("emptyDeliveries")} />
          ) : (
