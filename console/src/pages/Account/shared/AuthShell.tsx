import { AnimatedIcon, ArrowNarrowLeftIcon, FileDescriptionIcon, MagnifierIcon, RadioIcon } from "nfx-ui/icons";
...
export default function AuthShell({ brandTitle, brandEyebrow, heroFooter, children }: AuthShellProps) {
  ...
  const pillars = [
    { icon: FileDescriptionIcon, title: t("pillarIdentityTitle"), body: t("pillarIdentityBody") },
    { icon: MagnifierIcon, title: t("pillarCommunityTitle"), body: t("pillarCommunityBody") },
    { icon: RadioIcon, title: t("pillarLinkTitle"), body: t("pillarLinkBody") },
  ] as const;
