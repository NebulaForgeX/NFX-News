...
import { ArrowLeft, Newspaper, Radio, Search } from "lucide-react";
...
export default function AuthShell({ brandTitle, brandEyebrow, heroFooter, children }: AuthShellProps) {
  ...
  const pillars = [
    { icon: Newspaper, title: t("pillarIdentityTitle"), body: t("pillarIdentityBody") },
    { icon: Search, title: t("pillarCommunityTitle"), body: t("pillarCommunityBody") },
    { icon: Radio, title: t("pillarLinkTitle"), body: t("pillarLinkBody") },
  ] as const;
