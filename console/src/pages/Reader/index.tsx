import { FileDescriptionIcon, MagnifierIcon } from "nfx-ui/icons";
        ...
        <Flex direction="column" gap="3">
          <Flex align="center" justify="between" gap="2">
            <Box {...listeners} style={{ cursor: "grab", flex: 1 }}>
              <CardHeader icon={<FileDescriptionIcon size={18} />} title={source.name || source.id} description={source.column || source.type} />
            </Box>
...
const ReaderPage = memo(() => {
  ...
  return (
    <PageFrame>
      ...
      {q ? (
        <Card mb="4">
          <CardHeader icon={<MagnifierIcon size={18} />} title={t("results")} />
          {searchRows.length === 0 ? (
