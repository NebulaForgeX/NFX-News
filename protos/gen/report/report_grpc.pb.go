...
const (
	...
	ReportService_ListKeywords_FullMethodName   = "/report.ReportService/ListKeywords"
)
...
func (c *reportServiceClient) ListKeywords(ctx context.Context, in *ListKeywordsRequest, opts ...grpc.CallOption) (*ListKeywordsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListKeywordsResponse)
	err := c.cc.Invoke(ctx, ReportService_ListKeywords_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedReportServiceServer) ListKeywords(context.Context, *ListKeywordsRequest) (*ListKeywordsResponse, error) {
...
func _ReportService_ListKeywords_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListKeywordsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReportServiceServer).ListKeywords(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReportService_ListKeywords_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReportServiceServer).ListKeywords(ctx, req.(*ListKeywordsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ReportService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ReportService_ListKeywords_Handler,
		},
	},
