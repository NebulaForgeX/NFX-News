...
const (
	NotifyService_DispatchReport_FullMethodName = "/notify.NotifyService/DispatchReport"
)
...
type NotifyServiceClient interface {
	DispatchReport(ctx context.Context, in *DispatchReportRequest, opts ...grpc.CallOption) (*DispatchReportResponse, error)
}
...
func (c *notifyServiceClient) DispatchReport(ctx context.Context, in *DispatchReportRequest, opts ...grpc.CallOption) (*DispatchReportResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DispatchReportResponse)
	err := c.cc.Invoke(ctx, NotifyService_DispatchReport_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NotifyServiceServer interface {
	DispatchReport(context.Context, *DispatchReportRequest) (*DispatchReportResponse, error)
...
func (UnimplementedNotifyServiceServer) DispatchReport(context.Context, *DispatchReportRequest) (*DispatchReportResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DispatchReport not implemented")
}
...
func _NotifyService_DispatchReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DispatchReportRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NotifyServiceServer).DispatchReport(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotifyService_DispatchReport_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotifyServiceServer).DispatchReport(ctx, req.(*DispatchReportRequest))
	}
...
var NotifyService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "DispatchReport",
			Handler:    _NotifyService_DispatchReport_Handler,
		},
	},
